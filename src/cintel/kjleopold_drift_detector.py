...
REFERENCE_FILE: Final[Path] = DATA_DIR / "reference_metrics_kjleopold.csv"
CURRENT_FILE: Final[Path] = DATA_DIR / "current_metrics_kjleopold.csv"

OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_kjleopold.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_kjleopold.csv"
